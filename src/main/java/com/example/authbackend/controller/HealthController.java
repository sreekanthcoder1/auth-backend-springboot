...
public class HealthController {
    ...
    public ResponseEntity<Map<String, Object>> health() {
        ...
        try {
            ...
            config.put("jwtSecretConfigured", environment.getProperty("app.jwt.secret") != null);
            config.put("corsOrigins", environment.getProperty("spring.web.cors.allowed-origins"));
            config.put("h2ConsoleEnabled", environment.getProperty("spring.h2.console.enabled", "false"));
    ...
    public ResponseEntity<Map<String, Object>> info() {
        ...
        envVars.put("SPRING_PROFILES_ACTIVE", environment.getProperty("SPRING_PROFILES_ACTIVE"));
        envVars.put("DATABASE_URL_SET", environment.getProperty("DATABASE_URL") != null);
        envVars.put("MYSQL_URL_SET", environment.getProperty("MYSQL_URL") != null);
        envVars.put("JWT_SECRET_SET", environment.getProperty("JWT_SECRET") != null);
